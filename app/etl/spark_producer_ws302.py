...
logger.info("=" * 80)
logger.info("🚀 PRODUCTOR KAFKA - WS302 SONIDO")
logger.info("=" * 80)

KAFKA_BROKER = 'kafka:9092'
KAFKA_TOPIC = 'datos_sensores'
data_folder = Path("/opt/spark/data")
archivo = "WS302-915M SONIDO NOV 2024.csv"
    ...
    try:
        ...
        for col in columnas_filtradas:
            if col in df.columns:
                valor = row[col]
                # Para WS302, incluir campos de object incluso si están vacíos
                if pd.isna(valor):
        ...
        # Asegurar que siempre haya un objeto "object" para WS302
